...
const strings = {
  en: {
    ...
    'duplicates.scanning':         'Scanning your library…',
    'duplicates.summary':          '{groups} group(s) · {files} duplicate file(s)',
    'duplicates.empty':            'No duplicates found — your library is clean.',
    'duplicates.error':            "Couldn't scan for duplicates. Please try again.",
    'duplicates.untitled':         'Untitled',
    'duplicates.original':         'Original',
    'duplicates.delete':           'Delete',
    'duplicates.copies':           '{n} copies',
    'duplicates.keep_oldest':      'Keep oldest, delete {n}',
    'duplicates.not_same':         'Not duplicates',
    'similar.title':               'Similar to {name}',
    'duplicates.reason.exact':     'Exact copy',
    'duplicates.reason.potential': 'Potential match',
    'duplicates.reason.identical': 'Identical image',
    'duplicates.reason.similar':   'Looks similar',
    'duplicates.confirm_title':    'Delete duplicates?',
    'duplicates.confirm_msg':      'This permanently removes {n} duplicate file(s) from your library. The oldest copy is kept.',
    'duplicates.confirm_ok':       'Delete',
  ...
  uz: {
    ...
    // Duplicates
    'nav.duplicates':              'Dublikatlar',
    'duplicates.title':            'Dublikatlar',
    'duplicates.scanning':         'Kutubxona tekshirilmoqda…',
    'duplicates.summary':          '{groups} guruh · {files} dublikat fayl',
    'duplicates.empty':            'Dublikatlar topilmadi — kutubxonangiz toza.',
    'duplicates.error':            "Dublikatlarni tekshirib bo'lmadi. Qayta urinib ko'ring.",
    'duplicates.untitled':         'Nomsiz',
    'duplicates.original':         'Asl nusxa',
    'duplicates.delete':           "O'chirish",
    'duplicates.copies':           '{n} nusxa',
    'duplicates.keep_oldest':      "Eng eskisini qoldirib, {n} tasini o'chirish",
    'duplicates.not_same':         'Dublikat emas',
    'similar.title':               "{name}ga o'xshash",
    'duplicates.reason.exact':     'Aniq nusxa',
    'duplicates.reason.potential': 'Ehtimoliy nusxa',
    'duplicates.reason.identical': 'Bir xil rasm',
    'duplicates.reason.similar':   "O'xshash",
    'duplicates.confirm_title':    "Dublikatlar o'chirilsinmi?",
    'duplicates.confirm_msg':      "Bu {n} ta dublikat faylni kutubxonadan butunlay o'chiradi. Eng eski nusxa qoldiriladi.",
    'duplicates.confirm_ok':       "O'chirish",
