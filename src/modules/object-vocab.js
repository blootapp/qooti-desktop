...
export const OBJECT_VOCAB = [
  ...
  // ── Electronics ──
  ['phone','telefon'],['smartphone','smartfon'],['laptop','noutbuk'],['computer','kompyuter'],['monitor','monitor'],['keyboard','klaviatura'],['mouse','sichqoncha'],['tablet','planshet'],['camera','kamera'],['headphones','naushnik'],['speaker','karnay'],['microphone','mikrofon'],['television','televizor'],['tv','televizor'],['cassette','kasseta'],['remote','pult'],['printer','printer'],['router','router'],['charger','zaryadlagich'],['battery','batareya'],['game controller','o‘yin pulti'],['light bulb','lampochka'],['flashlight','fonar'],['hair drier','fen'],
